---
title: "Hero Data Model, Helpers, and Image Assets Guide"
...
| id | Superhero | Publisher |
|---|---|---|
| `dc-batman` | Batman | DC Comics |
| `dc-superman` | Superman | DC Comics |
| `dc-flash` | Flash | DC Comics |
| `dc-green` | Green Lantern | DC Comics |
| `dc-arrow` | Green Arrow | DC Comics |
| `dc-wonder` | Wonder Woman | DC Comics |
| `dc-martian` | Martian Manhunter | DC Comics |
| `dc-robin` | Robin/Nightwing | DC Comics |
| `dc-blue` | Blue Beetle | DC Comics |
| `dc-black` | Black Canary | DC Comics |
| `marvel-captain` | Captain America | Marvel Comics |
| `marvel-cyclops` | Cyclops | Marvel Comics |
| `marvel-daredevil` | Daredevil | Marvel Comics |
| `marvel-hawkeye` | Hawkeye | Marvel Comics |
| `marvel-hulk` | Hulk | Marvel Comics |
| `marvel-iron` | Iron Man | Marvel Comics |
| `marvel-silver` | Silver Surfer | Marvel Comics |
| `marvel-spider` | Spider-Man | Marvel Comics |
| `marvel-thor` | Thor | Marvel Comics |
| `marvel-wolverine` | Wolverine | Marvel Comics |
